    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <img src="{{asset('assets/images/SubCategory/Gadgets/Iphone.png')}}"
                     class="img-fluid rounded" alt="Iphone">
            </div>
            ...
            <div class="col-lg-8">
                ...
                <form action="{{ route('cart.add') }}" method="POST" class="d-inline me-2">
                    ...
                    <input type="hidden" name="image" value="{{ asset('assets/images/SubCategory/Gadgets/Iphone.png') }}">
