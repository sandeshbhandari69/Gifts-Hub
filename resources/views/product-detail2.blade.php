    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <img src="{{ asset('assets/images/SubCategory/Gadgets/laptop.png') }}"
                     class="img-fluid rounded" alt="Hp Laptop">
            </div>
            ...
            <div class="col-lg-8">
                ...
                <p>
                    A Mar Watch is a specialized device designed to monitor and track
                    environmental and weather conditions in real time.
                </p>
                ...
                <form action="{{ route('cart.add') }}" method="POST" class="d-inline me-2">
                    @csrf
                    <input type="hidden" name="id" value="hp-laptop">
                    <input type="hidden" name="name" value="HpLaptop">
                    <input type="hidden" name="price" value="$499.99">
                    <input type="hidden" name="image" value="{{ asset('assets/images/SubCategory/Gadgets/laptop.png') }}">
        ...
        <div class="my-5">
            ...
            <p>
                A Mar Watch is a specialized device designed to monitor and track
                environmental and weather conditions in real time. It collects data
                on temperature, humidity, air pressure, and other atmospheric changes.
            </p>
        </div>
    </div>
</section>
...
<section class="my-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    <img src="{{ asset('assets/images/SubCategory/Gadgets/watch.png') }}" class="card-img-top">
                    <div class="card-body text-center">
                        <h6>Hp Laptop</h6>
                        <h5>$199.99</h5>
                    </div>
